    ...
    for chunk_data in metadata["chunks"]:
        ...
        for item in chunk_data["items"]:
            ...
            atom = {
                ...
                "source_link": f'[[{context["source_link"]}#^chunk-{chunk_idx:02d}]]' if context.get("source_link") else "",
                "source_path": f'02-sources/books/{context["source_link"]}.md#^chunk-{chunk_idx:02d}' if context.get("source_link") else "",
