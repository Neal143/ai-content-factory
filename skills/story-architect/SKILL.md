...
### Bước 3: Đánh giá Lesson & Khách quan hóa
Sợi dây DIKW (Tầng 4 -> Tầng 3 -> Tầng 2) bắt buộc phải thông suốt. File A (Lesson) luôn được tạo mới. Lesson phải được đảm bảo tính khách quan trước khi lưu.
...
- **File A (Node Tầng 3 - Lesson):** Tạo File A bình thường. Lesson đã khách quan hóa. Chọn 1 trong 8 `knowledge_type`. BẮT BUỘC cấy biến:
...
Tạo YAML frontmatter cho các file được khởi tạo, tuân thủ triệt để cấu trúc KCS uy tín.
...
```
*(Thay thế bằng đường dẫn tương đối thực tế, phân cách bằng dấu phẩy KHÔNG có khoảng trắng).*
