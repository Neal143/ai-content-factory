...
- DONE: 272 | DLQ: 9 | CAP_RESERVED: 0 | MISSING: 11
  ...
  ❌ Chunk 16 — [story] Hari (6 tuổi), Annika (4 tuổi) và bố Ray
  ❌ Chunk 17 — [vivid_knowledge] Lăng kính Rối loạn cảm xúc (Dysregulation) thay vì
  ❌ Chunk 17 — [vivid_knowledge] Phản hồi "Hai điều đều đúng" (Two Things Are True)
  ❌ Chunk 22 — [story] Braeden và cha (Ethan)-unknown
  ❌ Chunk 26 — [vivid_knowledge] concept: Bản chất thực sự của sự tự tin [NOT_FOUND
  ❌ Chunk 26 — [vivid_knowledge] actionable_rule: Khen ngợi quá trình thay vì kết q
