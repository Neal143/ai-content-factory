...
> **Last Update**: 11/06/2026 15:33 (GMT+7)
# Workflow: Viết bài viral (Content Post)
> **LỆNH**: `/content-post [yêu cầu]` | `/content-post tiếp tục`
> PIPELINE_STATUS: SẴN SÀNG

## Output Rules
- Run folder: `vault/.content-pipeline/runs/[YYYY-MM-DD_HHmmss]_[topic-slug]/` (BẮT BUỘC: YYYY-MM-DD_HHmmss phải tính theo múi giờ GMT+7 Việt Nam).
