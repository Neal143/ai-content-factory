...
### Bước 2: Đề xuất Combo & Negotiation (USER INTERACTION)
> ⚠️ **Quy tắc Vòng lặp:** Phải lặp lại toàn bộ Bước 2 này cho **từng mẩu nội dung** riêng biệt. Tuyệt đối không gom/trộn lẫn dữ liệu của nhiều mẩu nội dung vào chung một lần thực thi.

Agent tự phân tích nội dung → đề xuất combo đầy đủ cùng lúc cho user xác nhận.

**2.1. Chọn Combo (theo type):**
...
**2.3. Xử lý phản hồi user:**
- **User đồng ý:** Chốt combo → sang Bước 3.
...
**2.4. Topic Resolution (sau khi Combo chốt):**
...
### Bước 3: Tạo Atom file theo template chuẩn
...
### Bước 4.5: Cập nhật Personal Atoms Queue
