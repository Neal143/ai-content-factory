...
3. Lưu bài vào 2 nơi:
   ...
   - `output/posts/[YYYY-MM-DD]-[topic-slug].md`
     ...
     - Giữa các đoạn: chèn marker ------ cách dòng trên 1 dòng trống, cách dòng dưới 1 dòng trống
4. Cập nhật `output/logs/production-log.md` — append entry:
   ```
...
5. Cập nhật `output/logs/hook-history.md` — append 1 dòng vào bảng:
   ...
   ```
6. Kiểm tra **pillar diversity**: Đọc production-log, đảm bảo không trùng pillar 2 bài liên tiếp.
